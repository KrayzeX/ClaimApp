...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_6520 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_6520(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_6521 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_6521(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6522 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6522(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6523 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6523(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6524 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6524(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6525 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6525(reader);
}
});
...
var G__6536 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__6537 = s.append(c);
c = G__6536;
s = G__6537;
continue;
}
