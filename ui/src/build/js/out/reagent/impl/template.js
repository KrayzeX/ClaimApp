...
var G__4972 = o;
goog.object.set(G__4972,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__4973__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__4973 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__4974__i = 0, G__4974__a = new Array(arguments.length -  0);
while (G__4974__i < G__4974__a.length) {G__4974__a[G__4974__i] = arguments[G__4974__i + 0]; ++G__4974__i;}
  args = new cljs.core.IndexedSeq(G__4974__a,0,null);
} 
return G__4973__delegate.call(this,args);};
G__4973.cljs$lang$maxFixedArity = 0;
G__4973.cljs$lang$applyTo = (function (arglist__4975){
var args = cljs.core.seq(arglist__4975);
...
var G__4976 = o;
goog.object.set(G__4976,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__4978__i = 0, G__4978__a = new Array(arguments.length -  0);
while (G__4978__i < G__4978__a.length) {G__4978__a[G__4978__i] = arguments[G__4978__i + 0]; ++G__4978__i;}
  args = new cljs.core.IndexedSeq(G__4978__a,0,null);
} 
return G__4977__delegate.call(this,args);};
G__4977.cljs$lang$maxFixedArity = 0;
G__4977.cljs$lang$applyTo = (function (arglist__4979){
...
var G__4980 = props;
var G__4980__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4980,cljs.core.cst$kw$id,id):G__4980);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4980__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__4981 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4981,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__4981;
}
})(),id_class);
...
var G__4982 = (cljs.core.count(argv) - first_child);
switch (G__4982) {
case (0):
...
break;
case (1):
var G__4983 = component;
var G__4984 = jsprops;
var G__4985 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__4983,G__4984,G__4985);
...
var vec__4987 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4987,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4987,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4987,(2),null);
...
var temp__5739__auto___4990 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___4990 == null)){
} else {
var key_4991 = temp__5739__auto___4990;
(jsprops.key = key_4991);
}
...
var temp__5739__auto___4994 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___4994 == null)){
} else {
var key_4995 = temp__5739__auto___4994;
(jsprops.key = key_4995);
}

var G__4992 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__4993 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__4992,G__4993);
});
/**
...
var temp__5739__auto___4996 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___4996 == null)){
} else {
var key_4997 = temp__5739__auto___4996;
(jsprops.key = key_4997);
}
...
var temp__5739__auto___4998 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___4998 == null)){
} else {
var key_4999 = temp__5739__auto___4998;
(jsprops.key = key_4999);
}
...
var temp__5739__auto___5000 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___5000 == null)){
} else {
var key_5001 = temp__5739__auto___5000;
(jsprops.key = key_5001);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5002_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__5002_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__5003 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5003,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5003,(1),null);
...
var G__5010 = tag;
var G__5010__$1 = (((G__5010 instanceof cljs.core.Keyword))?G__5010.fqn:null);
switch (G__5010__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template5013 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template5013 = (function (opts,id,fn_to_element,meta5014){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template5013.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5015,meta5014__$1){
var self__ = this;
var _5015__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template5013(self__.opts,self__.id,self__.fn_to_element,meta5014__$1));
}));

(reagent.impl.template.t_reagent$impl$template5013.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5015){
var self__ = this;
var _5015__$1 = this;
return self__.meta5014;
}));

(reagent.impl.template.t_reagent$impl$template5013.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template5013.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template5013.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template5013.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template5013.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta5014], null);
}));

(reagent.impl.template.t_reagent$impl$template5013.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template5013.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template5013");

(reagent.impl.template.t_reagent$impl$template5013.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template5013");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template5013.
 */
reagent.impl.template.__GT_t_reagent$impl$template5013 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template5013(opts__$1,id__$1,fn_to_element__$1,meta5014){
return (new reagent.impl.template.t_reagent$impl$template5013(opts__$1,id__$1,fn_to_element__$1,meta5014));
});

}

return (new reagent.impl.template.t_reagent$impl$template5013(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
